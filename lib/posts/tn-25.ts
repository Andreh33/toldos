...
export const posts: BlogPost[] = [
  {
    slug: "toldo-descuadrado-o-torcido-solucion",
    title: "Toldo descuadrado o torcido: causas y solución",
    metaDescription:
      "¿Tu toldo cierra torcido o se ha quedado descuadrado? Descubre las causas de un toldo torcido y descuadrado y cómo lo solucionamos en Madrid y Tarragona.",
    excerpt:
      "Un toldo que cierra torcido, con la barra de carga inclinada o un brazo más caído que el otro, no es solo una cuestión de estética: reparte mal las fuerzas y acelera el desgaste. Te contamos por qué se descuadra un toldo, qué puedes revisar tú y cuándo conviene la reparación.",
    date: "2026-07-01",
    category: "Mantenimiento y reparación",
    readingMinutes: 14,
    keywords: [
      "toldo torcido descuadrado",
      "toldo torcido",
      "toldo descuadrado",
      "barra de carga inclinada",
      "brazos descompensados",
      "enderezar toldo",
      "reparar toldo torcido",
      "toldo cierra mal",
    ],
    sections: [
      {
        heading: "Qué significa que un toldo esté descuadrado o torcido",
        paragraphs: [
      ...
      {
        heading: "Señales de que tu toldo está torcido o descuadrado",
        paragraphs: [
      ...
      {
        heading: "Por qué se descuadra un toldo: las causas más frecuentes",
        paragraphs: [
      ...
      {
        heading: "Brazos descompensados: la causa número uno",
        paragraphs: [
      ...
      {
        heading: "El enrollado desigual de la lona en el eje",
        paragraphs: [
      ...
      {
        heading: "Anclajes, soportes y fachada: cuando el problema está en el montaje",
        paragraphs: [
      ...
      {
        heading: "El cofre y los perfiles que ya no cierran alineados",
        paragraphs: [
      ...
      {
        heading: "Qué puedes comprobar tú y qué no debes tocar",
        paragraphs: [
      ...
      {
        heading: "Cómo enderezamos un toldo torcido: la reparación paso a paso",
        paragraphs: [
      ...
      {
        heading: "Cuándo el descuadre esconde un cambio de lona",
        paragraphs: [
      ...
      {
        heading: "Cómo evitar que se vuelva a descuadrar",
        paragraphs: [
      ...
      {
        heading: "Preguntas frecuentes sobre el toldo torcido o descuadrado",
        paragraphs: [
  ...
  {
    slug: "como-medir-la-lona-para-el-recambio",
    title: "Cómo medir la lona para pedir el recambio exacto",
    metaDescription:
      "¿Vas a cambiar la tela? Aprende a medir la lona del toldo para pedir el recambio exacto: ancho, salida, sistema de fijación y errores a evitar.",
    excerpt:
      "Un recambio de lona solo encaja bien si las medidas son exactas. Te explicamos paso a paso cómo medir el ancho, la salida y el sistema de fijación de tu toldo, y qué datos y fotos necesitas para pedir la tela sin equivocarte.",
    date: "2026-07-01",
    category: "Mantenimiento y reparación",
    readingMinutes: 14,
    keywords: [
      "medir lona toldo recambio",
      "medir lona toldo",
      "recambio lona toldo",
      "ancho y salida toldo",
      "sistema de fijación lona",
      "cambiar tela toldo",
      "medidas toldo extensible",
      "keder y jareta toldo",
    ],
    sections: [
      {
        heading: "Por qué medir bien la lona es tan importante",
        paragraphs: [
      ...
      {
        heading: "Antes de medir: identifica qué tipo de toldo tienes",
        paragraphs: [
      ...
      {
        heading: "Las dos medidas maestras: ancho y salida",
        paragraphs: [
      ...
      {
        heading: "Cómo medir el ancho correctamente",
        paragraphs: [
      ...
      {
        heading: "Cómo medir la salida o avance",
        paragraphs: [
      ...
      {
        heading: "El sistema de fijación: jareta, keder, vaina u ojales",
        paragraphs: [
      ...
      {
        heading: "El faldón, el volante y otros detalles a medir",
        paragraphs: [
      ...
      {
        heading: "Cofre, capota y vertical: particularidades de medición",
        paragraphs: [
      ...
      {
        heading: "Errores frecuentes al medir y cómo evitarlos",
        paragraphs: [
      ...
      {
        heading: "Qué datos y fotos enviarnos para un recambio exacto",
        paragraphs: [
      ...
      {
        heading: "Medir bien es la mitad del trabajo",
        paragraphs: [
      ...
      {
        heading: "Preguntas frecuentes sobre medir la lona para el recambio",
        paragraphs: [
    ...
    internalLinks: [
      { label: "Reparación y cambio de lona", href: "/servicios/reparaciones" },
      { label: "Toldos a medida", href: "/servicios/a-medida" },
